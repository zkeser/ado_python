...
from ado_iteration_automation.update_teams import update_teams_with_iterations  
...
if __name__ == "__main__":
    ...
    test = update_teams_with_iterations(get_connection(), get_teams(get_connection()))
    pprint(test)